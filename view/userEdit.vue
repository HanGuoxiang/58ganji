		...
		<view class="cu-list menu card-menu margin-top-xl margin-bottom-xl shadow-lg">
			<view class="cu-item arrow" @tap="ChooseImage">
				...
				<view class="user-data">
					<view class="cu-avatar round margin-left" :style="{backgroundImage:'url('+user.avatar+')'}"></view>
				</view>
			</view>
			<view class="cu-item arrow" @tap="showModal" data-target="DialogModalnickname">
				<view class="content">
			...
			<view class="cu-item arrow" @tap="noEdit">
				...
				<view class="user-data">
					<text class="text-grey">{{user.injoin}}</text>
				</view>
			</view>
			<view class="cu-item arrow" @tap="noEdit">
				<view class="content">
