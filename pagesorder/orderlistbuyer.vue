...
<script>
	...
	export default{
		...
		onLoad(data) {
			data.data="{\"ID\":\"10005\",\"OrderType\":\"10217\",\"创建日期\":\"2021/5/25 15:17:26\",\"操作人\":\"10000\",\"父账号ID\":\"10000\",\"分类名称\":\"二手物品\",\"图片\":\"6ba897eb-172a-4484-9e08-c14cb00a0830.png\",\"父分类ID\":\"10000\",\"层级\":\"1\",\"所属分类类型\":\"10000\",\"url\":\"https://local.softmarket.cn/UploadFiles/6ba897eb-172a-4484-9e08-c14cb00a0830.png\",\"SubCatalogTotalLevelCount\":1}";
		...
		methods:{
			...
			reloadByID(orderStatusID)
			{
				...
				+"&ordertype="+this.orderType+"&orderstatus="+orderStatusID+"&orderuserencryptid="+c.getUser(false).EncryptID+"&pageindex=0&pagesize=50&isquerymy=1&queryuserencryptid="+c.getUser(true).EncryptID,(data)=>{
					 // console.log('data'+data+JSON.stringify(data));
					 if(data.Status==1)
					 {
